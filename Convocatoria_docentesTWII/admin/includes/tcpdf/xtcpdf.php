<?php 
include 'tcpdf.php';
//include 'tcpdf/tcpdf/config/lang/spa');

class XTCPDF extends TCPDF 
{ 
    private $autor  = 'Mihael Adhemar Cruz Salas'; 
    private $sistema  = 'PaladArt';
    private $copyright  = '';
    private $titulo = 'PALADART';
    private $subtitulo = 'Sistema de Gestión de Datos';
    private $titulo_reporte = '';
    private $palabras_claves = 'PALADART';
        ...
        if ($this->header_footer) {
            if ($this->getPage() == 1) {
               ...
               $this->SetFillColor(255, 255, 255);
                ...
                $this->SetY($y + 1);
                $this->Image('../img/logo2.png', 20, '', '', 18);
...
//                
                ...
                $this->MultiCell('', 6, date('d/m/Y'), 0, 'C', '', 1, '', '', 1, '', '', '', 6, 'M');
                $this->SetTextColor(0, 0, 0);
...
//                $this->MultiCell(30, 4, date('d/m/Y H:i'), 0, 'C', '', '', 170, '', 1, '', '', '', 4, 'M');
                ...
                $this->Cell(90, 10, date('d/m/Y'), 0, 0, 'R');
                $this->Ln();
                $this->SetY(12);
